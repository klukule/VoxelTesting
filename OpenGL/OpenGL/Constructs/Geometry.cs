...
namespace klukule.OpenGL
{
    public class Geometry
    {
        ...
        public static VAO CreateCubeWithNormals(ShaderProgram program, Vector3 min, Vector3 max)
        {
            ...
            {
                new Vector2(0.0,0.0), new Vector2(1.0,0.0), new Vector2(1.0,1.0), new Vector2(0.0,1.0),
                new Vector2(0.0,0.0), new Vector2(1.0,0.0), new Vector2(1.0,1.0), new Vector2(0.0,1.0),
                new Vector2(0.0,0.0), new Vector2(1.0,0.0), new Vector2(1.0,1.0), new Vector2(0.0,1.0),
                new Vector2(0.0,0.0), new Vector2(1.0,0.0), new Vector2(1.0,1.0), new Vector2(0.0,1.0)
            };
            ...
            return new VAO(program, new VBO<Vector3>(vertex), new VBO<Vector3>(normal),new VBO<Vector2>(uv), new VBO<int>(element, BufferTarget.ElementArrayBuffer, BufferUsageHint.StaticRead));
        }
    }
}
