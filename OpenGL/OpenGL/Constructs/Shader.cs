...
namespace klukule.OpenGL
{
    ...
    public class ProgramParam
    {
        ...
        /// <summary>
        /// Specifies the location of the parameter in the klukule.OpenGL program.
        /// </summary>
        public int Location { get { return location; } }

        /// <summary>
        /// Specifies the klukule.OpenGL program ID.
        /// </summary>
        ...
        /// <param name="ParamType">Specifies the parameter type (either attribute or uniform).</param>
        /// <param name="Name">Specifies the case-sensitive name of the parameter.</param>
        /// <param name="Program">Specifies the klukule.OpenGL program ID.</param>
        ...
        #region GetLocation
        /// <summary>
        /// Gets the location of the parameter in a compiled klukule.OpenGL program.
        /// </summary>
        ...
        public void GetLocation(ShaderProgram Program)
        {
            ...
            if (programid == 0)
            {
                ...
                location = (ptype == klukule.OpenGL.ParamType.Uniform ? Program.GetUniformLocation(name) : Program.GetAttributeLocation(name));
            }
        }
        #endregion
        ...
        public void SetValue(Texture param)
        {
            ...
            Gl.Uniform1i(location, (int)param.TextureID);
        }
        #endregion
    }
    ...
    public class Shader : IDisposable
    {
        #region Properties
        /// <summary>
        /// Specifies the klukule.OpenGL ShaderID.
        /// </summary>
    ...
    public class ShaderProgram : IDisposable
    {
        #region Properties
        /// <summary>
        /// Specifies the klukule.OpenGL shader program ID.
        /// </summary>
