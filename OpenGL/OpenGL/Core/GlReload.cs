...
namespace klukule.OpenGL
{
    public partial class Gl
    {
        ...
        /// <summary>
        /// Contains DllImports for the core klukule.OpenGL functions.
        /// </summary>
        ...
        /// <summary>
        /// Loads all klukule.OpenGL functions (core and extensions).
        /// </summary>
        /// <remarks>
        /// <para>
        /// This function will be automatically called the first time you use any klukule.OpenGL function. There is 
        /// </para>
        /// <para>
        /// Call this function manually whenever you need to update klukule.OpenGL entry points.
        ...
        /// <summary>
        /// Tries to reload the given klukule.OpenGL function (core or extension).
        /// </summary>
        /// <param name="function">The name of the klukule.OpenGL function (i.e. glShaderSource)</param>
        /// <returns>True if the function was found and reloaded, false otherwise.</returns>
        /// <remarks>
        /// <para>
        /// Use this function if you require greater granularity when loading klukule.OpenGL entry points.
        /// </para>
        /// <para>
        /// While the automatic initialisation will load all klukule.OpenGL entry points, in some cases
        /// the initialisation can take place before an klukule.OpenGL Context has been established.
        /// In this case, use this function to load the entry points for the klukule.OpenGL functions
        /// you will need, or use ReloadFunctions() to load all available entry points.
        /// </para>
        /// <para>
        /// This function returns true if the given klukule.OpenGL function is supported, false otherwise.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// Creates a System.Delegate that can be used to call an klukule.OpenGL function, core or extension.
        /// </summary>
        /// <param name="name">The name of the klukule.OpenGL function (eg. "glNewList")</param>
        /// <param name="signature">The signature of the klukule.OpenGL function.</param>
        /// <returns>
        /// A System.Delegate that can be used to call this klukule.OpenGL function, or null if the specified
        /// function name did not correspond to an klukule.OpenGL function.
        /// </returns>
        ...
        /// <summary>
        /// Creates a System.Delegate that can be used to call a dynamically exported klukule.OpenGL function.
        /// </summary>
        /// <param name="name">The name of the klukule.OpenGL function (eg. "glNewList")</param>
        /// <param name="signature">The signature of the klukule.OpenGL function.</param>
        /// <returns>
        /// A System.Delegate that can be used to call this klukule.OpenGL function or null
        /// if the function is not available in the current klukule.OpenGL context.
        /// </returns>
        ...
        /// <summary>
        /// Retrieves the entry point for a dynamically exported klukule.OpenGL function.
        /// </summary>
        /// <param name="function">The function string for the klukule.OpenGL function (eg. "glNewList")</param>
        /// <returns>
        /// An IntPtr contaning the address for the entry point, or IntPtr.Zero if the specified
        /// klukule.OpenGL function is not dynamically exported.
        /// </returns>
        /// <remarks>
        /// <para>
