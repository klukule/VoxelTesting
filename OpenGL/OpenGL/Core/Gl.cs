...
namespace klukule.OpenGL
{
    ...
    partial class Gl
    {
        ...
        public static void ActiveTexture(klukule.OpenGL.TextureUnit texture)
        {
        ...
        public static void BeginConditionalRender(UInt32 id, klukule.OpenGL.ConditionalRenderType mode)
        {
        ...
        public static void BeginQuery(klukule.OpenGL.QueryTarget target, UInt32 id)
        {
            Delegates.glBeginQuery(target, id);
        }

        public static void EndQuery(klukule.OpenGL.QueryTarget target)
        {
        ...
        public static void EndQueryIndexed(klukule.OpenGL.QueryTarget target, UInt32 index)
        {
            Delegates.glEndQueryIndexed(target, index);
        }

        public static void BeginTransformFeedback(klukule.OpenGL.BeginFeedbackMode primitiveMode)
        {
        ...
        public static void BindBuffer(klukule.OpenGL.BufferTarget target, UInt32 buffer)
        {
            Delegates.glBindBuffer(target, buffer);
        }

        public static void BindBufferBase(klukule.OpenGL.BufferTarget target, UInt32 index, UInt32 buffer)
        {
        ...
        public static void BindBuffersBase(klukule.OpenGL.BufferTarget target, UInt32 first, Int32 count, UInt32[] buffers)
        {
            Delegates.glBindBuffersBase(target, first, count, buffers);
        }

        public static void BindBuffersRange(klukule.OpenGL.BufferTarget target, UInt32 first, Int32 count, UInt32[] buffers, IntPtr[] offsets, IntPtr[] sizes)
        {
        ...
        public static void BindFramebuffer(klukule.OpenGL.FramebufferTarget target, UInt32 framebuffer)
        {
            Delegates.glBindFramebuffer(target, framebuffer);
        }

        public static void BindImageTexture(UInt32 unit, UInt32 texture, Int32 level, Boolean layered, Int32 layer, klukule.OpenGL.BufferAccess access, klukule.OpenGL.PixelInternalFormat format)
        {
        ...
        public static void BindRenderbuffer(klukule.OpenGL.RenderbufferTarget target, UInt32 renderbuffer)
        {
        ...
        public static void BindTexture(klukule.OpenGL.TextureTarget target, UInt32 texture)
        {
        ...
        public static void BindTransformFeedback(klukule.OpenGL.NvTransformFeedback2 target, UInt32 id)
        {
        ...
        public static void BlendEquation(klukule.OpenGL.BlendEquationMode mode)
        {
            Delegates.glBlendEquation(mode);
        }

        public static void BlendEquationi(UInt32 buf, klukule.OpenGL.BlendEquationMode mode)
        {
            Delegates.glBlendEquationi(buf, mode);
        }

        public static void BlendEquationSeparate(klukule.OpenGL.BlendEquationMode modeRGB, klukule.OpenGL.BlendEquationMode modeAlpha)
        {
            Delegates.glBlendEquationSeparate(modeRGB, modeAlpha);
        }

        public static void BlendEquationSeparatei(UInt32 buf, klukule.OpenGL.BlendEquationMode modeRGB, klukule.OpenGL.BlendEquationMode modeAlpha)
        {
            Delegates.glBlendEquationSeparatei(buf, modeRGB, modeAlpha);
        }

        public static void BlendFunc(klukule.OpenGL.BlendingFactorSrc sfactor, klukule.OpenGL.BlendingFactorDest dfactor)
        {
            Delegates.glBlendFunc(sfactor, dfactor);
        }

        public static void BlendFunci(UInt32 buf, klukule.OpenGL.BlendingFactorSrc sfactor, klukule.OpenGL.BlendingFactorDest dfactor)
        {
            Delegates.glBlendFunci(buf, sfactor, dfactor);
        }

        public static void BlendFuncSeparate(klukule.OpenGL.BlendingFactorSrc srcRGB, klukule.OpenGL.BlendingFactorDest dstRGB, klukule.OpenGL.BlendingFactorSrc srcAlpha, klukule.OpenGL.BlendingFactorDest dstAlpha)
        {
            Delegates.glBlendFuncSeparate(srcRGB, dstRGB, srcAlpha, dstAlpha);
        }

        public static void BlendFuncSeparatei(UInt32 buf, klukule.OpenGL.BlendingFactorSrc srcRGB, klukule.OpenGL.BlendingFactorDest dstRGB, klukule.OpenGL.BlendingFactorSrc srcAlpha, klukule.OpenGL.BlendingFactorDest dstAlpha)
        {
            Delegates.glBlendFuncSeparatei(buf, srcRGB, dstRGB, srcAlpha, dstAlpha);
        }

        public static void BlitFramebuffer(Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, klukule.OpenGL.ClearBufferMask mask, klukule.OpenGL.BlitFramebufferFilter filter)
        {
            Delegates.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
        }

        public static void BlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, klukule.OpenGL.ClearBufferMask mask, klukule.OpenGL.BlitFramebufferFilter filter)
        {
        ...
        public static void BufferData(klukule.OpenGL.BufferTarget target, IntPtr size, IntPtr data, klukule.OpenGL.BufferUsageHint usage)
        {
            Delegates.glBufferData(target, size, data, usage);
        }

        public static void NamedBufferData(UInt32 buffer, Int32 size, IntPtr data, klukule.OpenGL.BufferUsageHint usage)
        {
            Delegates.glNamedBufferData(buffer, size, data, usage);
        }

        public static void BufferStorage(klukule.OpenGL.BufferTarget target, IntPtr size, IntPtr data, UInt32 flags)
        {
        ...
        public static void BufferSubData(klukule.OpenGL.BufferTarget target, IntPtr offset, IntPtr size, IntPtr data)
        {
        ...
        public static klukule.OpenGL.FramebufferErrorCode CheckFramebufferStatus(klukule.OpenGL.FramebufferTarget target)
        {
            return Delegates.glCheckFramebufferStatus(target);
        }

        public static klukule.OpenGL.FramebufferErrorCode CheckNamedFramebufferStatus(UInt32 framebuffer, klukule.OpenGL.FramebufferTarget target)
        {
            return Delegates.glCheckNamedFramebufferStatus(framebuffer, target);
        }

        public static void ClampColor(klukule.OpenGL.ClampColorTarget target, klukule.OpenGL.ClampColorMode clamp)
        {
            Delegates.glClampColor(target, clamp);
        }

        public static void Clear(klukule.OpenGL.ClearBufferMask mask)
        {
            Delegates.glClear(mask);
        }

        public static void ClearBufferiv(klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, Int32[] value)
        {
            Delegates.glClearBufferiv(buffer, drawbuffer, value);
        }

        public static void ClearBufferuiv(klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, UInt32[] value)
        {
            Delegates.glClearBufferuiv(buffer, drawbuffer, value);
        }

        public static void ClearBufferfv(klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, Single[] value)
        {
            Delegates.glClearBufferfv(buffer, drawbuffer, value);
        }

        public static void ClearBufferfi(klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil)
        {
            Delegates.glClearBufferfi(buffer, drawbuffer, depth, stencil);
        }

        public static void ClearNamedFramebufferiv(UInt32 framebuffer, klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, Int32[] value)
        {
            Delegates.glClearNamedFramebufferiv(framebuffer, buffer, drawbuffer, value);
        }

        public static void ClearNamedFramebufferuiv(UInt32 framebuffer, klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, UInt32[] value)
        {
            Delegates.glClearNamedFramebufferuiv(framebuffer, buffer, drawbuffer, value);
        }

        public static void ClearNamedFramebufferfv(UInt32 framebuffer, klukule.OpenGL.ClearBuffer buffer, Int32 drawbuffer, Single[] value)
        {
            Delegates.glClearNamedFramebufferfv(framebuffer, buffer, drawbuffer, value);
        }

        public static void ClearNamedFramebufferfi(UInt32 framebuffer, klukule.OpenGL.ClearBuffer buffer, Single depth, Int32 stencil)
        {
            Delegates.glClearNamedFramebufferfi(framebuffer, buffer, depth, stencil);
        }

        public static void ClearBufferData(klukule.OpenGL.BufferTarget target, klukule.OpenGL.SizedInternalFormat internalFormat, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glClearBufferData(target, internalFormat, format, type, data);
        }

        public static void ClearNamedBufferData(UInt32 buffer, klukule.OpenGL.SizedInternalFormat internalFormat, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glClearNamedBufferData(buffer, internalFormat, format, type, data);
        }

        public static void ClearBufferSubData(klukule.OpenGL.BufferTarget target, klukule.OpenGL.SizedInternalFormat internalFormat, IntPtr offset, IntPtr size, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glClearBufferSubData(target, internalFormat, offset, size, format, type, data);
        }

        public static void ClearNamedBufferSubData(UInt32 buffer, klukule.OpenGL.SizedInternalFormat internalFormat, IntPtr offset, Int32 size, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
        ...
        public static void ClearTexImage(UInt32 texture, Int32 level, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glClearTexImage(texture, level, format, type, data);
        }

        public static void ClearTexSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelInternalFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glClearTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data);
        }

        public static klukule.OpenGL.ArbSync ClientWaitSync(IntPtr sync, UInt32 flags, UInt64 timeout)
        {
            return Delegates.glClientWaitSync(sync, flags, timeout);
        }

        public static void ClipControl(klukule.OpenGL.ClipControlOrigin origin, klukule.OpenGL.ClipControlDepth depth)
        {
        ...
        public static void CompressedTexImage1D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexImage1D(target, level, internalFormat, width, border, imageSize, data);
        }

        public static void CompressedTexImage2D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexImage2D(target, level, internalFormat, width, height, border, imageSize, data);
        }

        public static void CompressedTexImage3D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexImage3D(target, level, internalFormat, width, height, depth, border, imageSize, data);
        }

        public static void CompressedTexSubImage1D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, klukule.OpenGL.PixelFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexSubImage1D(target, level, xoffset, width, format, imageSize, data);
        }

        public static void CompressedTextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, klukule.OpenGL.PixelInternalFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTextureSubImage1D(texture, level, xoffset, width, format, imageSize, data);
        }

        public static void CompressedTexSubImage2D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, klukule.OpenGL.PixelFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
        }

        public static void CompressedTextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, klukule.OpenGL.PixelInternalFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, imageSize, data);
        }

        public static void CompressedTexSubImage3D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
        }

        public static void CompressedTextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelInternalFormat format, Int32 imageSize, IntPtr data)
        {
            Delegates.glCompressedTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
        }

        public static void CopyBufferSubData(klukule.OpenGL.BufferTarget readTarget, klukule.OpenGL.BufferTarget writeTarget, IntPtr readOffset, IntPtr writeOffset, IntPtr size)
        {
        ...
        public static void CopyImageSubData(UInt32 srcName, klukule.OpenGL.BufferTarget srcTarget, Int32 srcLevel, Int32 srcX, Int32 srcY, Int32 srcZ, UInt32 dstName, klukule.OpenGL.BufferTarget dstTarget, Int32 dstLevel, Int32 dstX, Int32 dstY, Int32 dstZ, Int32 srcWidth, Int32 srcHeight, Int32 srcDepth)
        {
        ...
        public static void CopyTexImage1D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 border)
        {
            Delegates.glCopyTexImage1D(target, level, internalFormat, x, y, width, border);
        }

        public static void CopyTexImage2D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 height, Int32 border)
        {
            Delegates.glCopyTexImage2D(target, level, internalFormat, x, y, width, height, border);
        }

        public static void CopyTexSubImage1D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width)
        {
        ...
        public static void CopyTexSubImage2D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 x, Int32 y, Int32 width, Int32 height)
        {
        ...
        public static void CopyTexSubImage3D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 x, Int32 y, Int32 width, Int32 height)
        {
        ...
        public static void CreateQueries(klukule.OpenGL.QueryTarget target, Int32 n, UInt32[] ids)
        {
        ...
        public static UInt32 CreateShader(klukule.OpenGL.ShaderType shaderType)
        {
            return Delegates.glCreateShader(shaderType);
        }

        public static UInt32 CreateShaderProgramv(klukule.OpenGL.ShaderType type, Int32 count, String strings)
        {
            return Delegates.glCreateShaderProgramv(type, count, strings);
        }

        public static void CreateTextures(klukule.OpenGL.TextureTarget target, Int32 n, UInt32[] textures)
        {
        ...
        public static void CullFace(klukule.OpenGL.CullFaceMode mode)
        {
        ...
        public static void DeleteFramebuffer(UInt32 framebuffer)
        {
            Delegates.glDeleteFramebuffers(1, new UInt32[] { framebuffer });
        }
        ...
        public static void DeleteTexture(UInt32 texture)
        {
            Delegates.glDeleteTextures(1, new uint[] { texture });
        }
        ...
        public static void DepthFunc(klukule.OpenGL.DepthFunction func)
        {
        ...
        public static void DrawArrays(klukule.OpenGL.BeginMode mode, Int32 first, Int32 count)
        {
            Delegates.glDrawArrays(mode, first, count);
        }

        public static void DrawArraysIndirect(klukule.OpenGL.BeginMode mode, IntPtr indirect)
        {
            Delegates.glDrawArraysIndirect(mode, indirect);
        }

        public static void DrawArraysInstanced(klukule.OpenGL.BeginMode mode, Int32 first, Int32 count, Int32 primcount)
        {
            Delegates.glDrawArraysInstanced(mode, first, count, primcount);
        }

        public static void DrawArraysInstancedBaseInstance(klukule.OpenGL.BeginMode mode, Int32 first, Int32 count, Int32 primcount, UInt32 baseinstance)
        {
            Delegates.glDrawArraysInstancedBaseInstance(mode, first, count, primcount, baseinstance);
        }

        public static void DrawBuffer(klukule.OpenGL.DrawBufferMode buf)
        {
            Delegates.glDrawBuffer(buf);
        }

        public static void NamedFramebufferDrawBuffer(UInt32 framebuffer, klukule.OpenGL.DrawBufferMode buf)
        {
            Delegates.glNamedFramebufferDrawBuffer(framebuffer, buf);
        }

        public static void DrawBuffers(Int32 n, klukule.OpenGL.DrawBuffersEnum[] bufs)
        {
            Delegates.glDrawBuffers(n, bufs);
        }

        public static void NamedFramebufferDrawBuffers(UInt32 framebuffer, Int32 n, klukule.OpenGL.DrawBufferMode[] bufs)
        {
            Delegates.glNamedFramebufferDrawBuffers(framebuffer, n, bufs);
        }

        public static void DrawElements(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices)
        {
            Delegates.glDrawElements(mode, count, type, indices);
        }

        public static void DrawElementsBaseVertex(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 basevertex)
        {
            Delegates.glDrawElementsBaseVertex(mode, count, type, indices, basevertex);
        }

        public static void DrawElementsIndirect(klukule.OpenGL.BeginMode mode, klukule.OpenGL.DrawElementsType type, IntPtr indirect)
        {
            Delegates.glDrawElementsIndirect(mode, type, indirect);
        }

        public static void DrawElementsInstanced(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 primcount)
        {
            Delegates.glDrawElementsInstanced(mode, count, type, indices, primcount);
        }

        public static void DrawElementsInstancedBaseInstance(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 primcount, UInt32 baseinstance)
        {
            Delegates.glDrawElementsInstancedBaseInstance(mode, count, type, indices, primcount, baseinstance);
        }

        public static void DrawElementsInstancedBaseVertex(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex)
        {
            Delegates.glDrawElementsInstancedBaseVertex(mode, count, type, indices, primcount, basevertex);
        }

        public static void DrawElementsInstancedBaseVertexBaseInstance(klukule.OpenGL.BeginMode mode, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex, UInt32 baseinstance)
        {
            Delegates.glDrawElementsInstancedBaseVertexBaseInstance(mode, count, type, indices, primcount, basevertex, baseinstance);
        }

        public static void DrawRangeElements(klukule.OpenGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices)
        {
            Delegates.glDrawRangeElements(mode, start, end, count, type, indices);
        }

        public static void DrawRangeElementsBaseVertex(klukule.OpenGL.BeginMode mode, UInt32 start, UInt32 end, Int32 count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 basevertex)
        {
            Delegates.glDrawRangeElementsBaseVertex(mode, start, end, count, type, indices, basevertex);
        }

        public static void DrawTransformFeedback(klukule.OpenGL.NvTransformFeedback2 mode, UInt32 id)
        {
            Delegates.glDrawTransformFeedback(mode, id);
        }

        public static void DrawTransformFeedbackInstanced(klukule.OpenGL.BeginMode mode, UInt32 id, Int32 primcount)
        {
            Delegates.glDrawTransformFeedbackInstanced(mode, id, primcount);
        }

        public static void DrawTransformFeedbackStream(klukule.OpenGL.NvTransformFeedback2 mode, UInt32 id, UInt32 stream)
        {
            Delegates.glDrawTransformFeedbackStream(mode, id, stream);
        }

        public static void DrawTransformFeedbackStreamInstanced(klukule.OpenGL.BeginMode mode, UInt32 id, UInt32 stream, Int32 primcount)
        {
            Delegates.glDrawTransformFeedbackStreamInstanced(mode, id, stream, primcount);
        }

        public static void Enable(klukule.OpenGL.EnableCap cap)
        {
            Delegates.glEnable(cap);
        }

        public static void Disable(klukule.OpenGL.EnableCap cap)
        {
            Delegates.glDisable(cap);
        }

        public static void Enablei(klukule.OpenGL.EnableCap cap, UInt32 index)
        {
            Delegates.glEnablei(cap, index);
        }

        public static void Disablei(klukule.OpenGL.EnableCap cap, UInt32 index)
        {
        ...
        public static IntPtr FenceSync(klukule.OpenGL.ArbSync condition, UInt32 flags)
        {
        ...
        public static void FlushMappedBufferRange(klukule.OpenGL.BufferTarget target, IntPtr offset, IntPtr length)
        {
        ...
        public static void FramebufferParameteri(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferPName pname, Int32 param)
        {
            Delegates.glFramebufferParameteri(target, pname, param);
        }

        public static void NamedFramebufferParameteri(UInt32 framebuffer, klukule.OpenGL.FramebufferPName pname, Int32 param)
        {
            Delegates.glNamedFramebufferParameteri(framebuffer, pname, param);
        }

        public static void FramebufferRenderbuffer(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer)
        {
            Delegates.glFramebufferRenderbuffer(target, attachment, renderbuffertarget, renderbuffer);
        }

        public static void NamedFramebufferRenderbuffer(UInt32 framebuffer, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer)
        {
            Delegates.glNamedFramebufferRenderbuffer(framebuffer, attachment, renderbuffertarget, renderbuffer);
        }

        public static void FramebufferTexture(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, UInt32 texture, Int32 level)
        {
            Delegates.glFramebufferTexture(target, attachment, texture, level);
        }

        public static void FramebufferTexture1D(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.TextureTarget textarget, UInt32 texture, Int32 level)
        {
            Delegates.glFramebufferTexture1D(target, attachment, textarget, texture, level);
        }

        public static void FramebufferTexture2D(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.TextureTarget textarget, UInt32 texture, Int32 level)
        {
            Delegates.glFramebufferTexture2D(target, attachment, textarget, texture, level);
        }

        public static void FramebufferTexture3D(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.TextureTarget textarget, UInt32 texture, Int32 level, Int32 layer)
        {
            Delegates.glFramebufferTexture3D(target, attachment, textarget, texture, level, layer);
        }

        public static void NamedFramebufferTexture(UInt32 framebuffer, klukule.OpenGL.FramebufferAttachment attachment, UInt32 texture, Int32 level)
        {
            Delegates.glNamedFramebufferTexture(framebuffer, attachment, texture, level);
        }

        public static void FramebufferTextureLayer(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer)
        {
            Delegates.glFramebufferTextureLayer(target, attachment, texture, level, layer);
        }

        public static void NamedFramebufferTextureLayer(UInt32 framebuffer, klukule.OpenGL.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer)
        {
            Delegates.glNamedFramebufferTextureLayer(framebuffer, attachment, texture, level, layer);
        }

        public static void FrontFace(klukule.OpenGL.FrontFaceDirection mode)
        {
        ...
        public static void GenerateMipmap(klukule.OpenGL.GenerateMipmapTarget target)
        {
        ...
        public static void GetBooleanv(klukule.OpenGL.GetPName pname, [OutAttribute] Boolean[] data)
        {
            Delegates.glGetBooleanv(pname, data);
        }

        public static void GetDoublev(klukule.OpenGL.GetPName pname, [OutAttribute] Double[] data)
        {
            Delegates.glGetDoublev(pname, data);
        }

        public static void GetFloatv(klukule.OpenGL.GetPName pname, [OutAttribute] Single[] data)
        {
            Delegates.glGetFloatv(pname, data);
        }

        public static void GetIntegerv(klukule.OpenGL.GetPName pname, [OutAttribute] Int32[] data)
        {
            Delegates.glGetIntegerv(pname, data);
        }

        public static void GetInteger64v(klukule.OpenGL.ArbSync pname, [OutAttribute] Int64[] data)
        {
            Delegates.glGetInteger64v(pname, data);
        }

        public static void GetBooleani_v(klukule.OpenGL.GetPName target, UInt32 index, [OutAttribute] Boolean[] data)
        {
            Delegates.glGetBooleani_v(target, index, data);
        }

        public static void GetIntegeri_v(klukule.OpenGL.GetPName target, UInt32 index, [OutAttribute] Int32[] data)
        {
            Delegates.glGetIntegeri_v(target, index, data);
        }

        public static void GetFloati_v(klukule.OpenGL.GetPName target, UInt32 index, [OutAttribute] Single[] data)
        {
            Delegates.glGetFloati_v(target, index, data);
        }

        public static void GetDoublei_v(klukule.OpenGL.GetPName target, UInt32 index, [OutAttribute] Double[] data)
        {
            Delegates.glGetDoublei_v(target, index, data);
        }

        public static void GetInteger64i_v(klukule.OpenGL.GetPName target, UInt32 index, [OutAttribute] Int64[] data)
        {
            Delegates.glGetInteger64i_v(target, index, data);
        }

        public static void GetActiveAtomicCounterBufferiv(UInt32 program, UInt32 bufferIndex, klukule.OpenGL.AtomicCounterParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, @params);
        }

        public static void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] klukule.OpenGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name)
        {
            Delegates.glGetActiveAttrib(program, index, bufSize, length, size, type, name);
        }

        public static void GetActiveSubroutineName(UInt32 program, klukule.OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name)
        {
            Delegates.glGetActiveSubroutineName(program, shadertype, index, bufsize, length, name);
        }

        public static void GetActiveSubroutineUniformiv(UInt32 program, klukule.OpenGL.ShaderType shadertype, UInt32 index, klukule.OpenGL.SubroutineParameterName pname, [OutAttribute] Int32[] values)
        {
            Delegates.glGetActiveSubroutineUniformiv(program, shadertype, index, pname, values);
        }

        public static void GetActiveSubroutineUniformName(UInt32 program, klukule.OpenGL.ShaderType shadertype, UInt32 index, Int32 bufsize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name)
        {
            Delegates.glGetActiveSubroutineUniformName(program, shadertype, index, bufsize, length, name);
        }

        public static void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] klukule.OpenGL.ActiveUniformType[] type, [OutAttribute] System.Text.StringBuilder name)
        {
            Delegates.glGetActiveUniform(program, index, bufSize, length, size, type, name);
        }

        public static void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, klukule.OpenGL.ActiveUniformBlockParameter pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetActiveUniformsiv(UInt32 program, Int32 uniformCount, [OutAttribute] UInt32[] uniformIndices, klukule.OpenGL.ActiveUniformType pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetBufferParameteriv(klukule.OpenGL.BufferTarget target, klukule.OpenGL.BufferParameterName value, [OutAttribute] Int32[] data)
        {
            Delegates.glGetBufferParameteriv(target, value, data);
        }

        public static void GetBufferParameteri64v(klukule.OpenGL.BufferTarget target, klukule.OpenGL.BufferParameterName value, [OutAttribute] Int64[] data)
        {
            Delegates.glGetBufferParameteri64v(target, value, data);
        }

        public static void GetNamedBufferParameteriv(UInt32 buffer, klukule.OpenGL.BufferParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetNamedBufferParameteriv(buffer, pname, @params);
        }

        public static void GetNamedBufferParameteri64v(UInt32 buffer, klukule.OpenGL.BufferParameterName pname, [OutAttribute] Int64[] @params)
        {
            Delegates.glGetNamedBufferParameteri64v(buffer, pname, @params);
        }

        public static void GetBufferPointerv(klukule.OpenGL.BufferTarget target, klukule.OpenGL.BufferPointer pname, [OutAttribute] IntPtr @params)
        {
            Delegates.glGetBufferPointerv(target, pname, @params);
        }

        public static void GetNamedBufferPointerv(UInt32 buffer, klukule.OpenGL.BufferPointer pname, [OutAttribute] IntPtr @params)
        {
            Delegates.glGetNamedBufferPointerv(buffer, pname, @params);
        }

        public static void GetBufferSubData(klukule.OpenGL.BufferTarget target, IntPtr offset, IntPtr size, [OutAttribute] IntPtr data)
        {
        ...
        public static void GetCompressedTexImage(klukule.OpenGL.TextureTarget target, Int32 level, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetCompressedTexImage(target, level, pixels);
        }

        public static void GetnCompressedTexImage(klukule.OpenGL.TextureTarget target, Int32 level, Int32 bufSize, [OutAttribute] IntPtr pixels)
        {
        ...
        public static klukule.OpenGL.ErrorCode GetError()
        {
        ...
        public static void GetFramebufferAttachmentParameteriv(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetFramebufferAttachmentParameteriv(target, attachment, pname, @params);
        }

        public static void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, klukule.OpenGL.FramebufferAttachment attachment, klukule.OpenGL.FramebufferParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetNamedFramebufferAttachmentParameteriv(framebuffer, attachment, pname, @params);
        }

        public static void GetFramebufferParameteriv(klukule.OpenGL.FramebufferTarget target, klukule.OpenGL.FramebufferPName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetFramebufferParameteriv(target, pname, @params);
        }

        public static void GetNamedFramebufferParameteriv(UInt32 framebuffer, klukule.OpenGL.FramebufferPName pname, [OutAttribute] Int32[] param)
        {
            Delegates.glGetNamedFramebufferParameteriv(framebuffer, pname, param);
        }

        public static klukule.OpenGL.GraphicResetStatus GetGraphicsResetStatus()
        {
            return Delegates.glGetGraphicsResetStatus();
        }

        public static void GetInternalformativ(klukule.OpenGL.TextureTarget target, klukule.OpenGL.PixelInternalFormat internalFormat, klukule.OpenGL.GetPName pname, Int32 bufSize, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetInternalformativ(target, internalFormat, pname, bufSize, @params);
        }

        public static void GetInternalformati64v(klukule.OpenGL.TextureTarget target, klukule.OpenGL.PixelInternalFormat internalFormat, klukule.OpenGL.GetPName pname, Int32 bufSize, [OutAttribute] Int64[] @params)
        {
            Delegates.glGetInternalformati64v(target, internalFormat, pname, bufSize, @params);
        }

        public static void GetMultisamplefv(klukule.OpenGL.GetMultisamplePName pname, UInt32 index, [OutAttribute] Single[] val)
        {
            Delegates.glGetMultisamplefv(pname, index, val);
        }

        public static void GetObjectLabel(klukule.OpenGL.ObjectLabel identifier, UInt32 name, Int32 bifSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label)
        {
        ...
        public static void GetPointerv(klukule.OpenGL.GetPointerParameter pname, [OutAttribute] IntPtr @params)
        {
            Delegates.glGetPointerv(pname, @params);
        }

        public static void GetProgramiv(UInt32 program, klukule.OpenGL.ProgramParameter pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetProgramInterfaceiv(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, klukule.OpenGL.ProgramInterfaceParameterName pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetProgramResourceiv(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, UInt32 index, Int32 propCount, [OutAttribute] klukule.OpenGL.ProgramResourceParameterName[] props, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length, @params);
        }

        public static UInt32 GetProgramResourceIndex(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, String name)
        {
            return Delegates.glGetProgramResourceIndex(program, programInterface, name);
        }

        public static Int32 GetProgramResourceLocation(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, String name)
        {
            return Delegates.glGetProgramResourceLocation(program, programInterface, name);
        }

        public static Int32 GetProgramResourceLocationIndex(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, String name)
        {
            return Delegates.glGetProgramResourceLocationIndex(program, programInterface, name);
        }

        public static void GetProgramResourceName(UInt32 program, klukule.OpenGL.ProgramInterface programInterface, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name)
        {
            Delegates.glGetProgramResourceName(program, programInterface, index, bufSize, length, name);
        }

        public static void GetProgramStageiv(UInt32 program, klukule.OpenGL.ShaderType shadertype, klukule.OpenGL.ProgramStageParameterName pname, [OutAttribute] Int32[] values)
        {
            Delegates.glGetProgramStageiv(program, shadertype, pname, values);
        }

        public static void GetQueryIndexediv(klukule.OpenGL.QueryTarget target, UInt32 index, klukule.OpenGL.GetQueryParam pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetQueryIndexediv(target, index, pname, @params);
        }

        public static void GetQueryiv(klukule.OpenGL.QueryTarget target, klukule.OpenGL.GetQueryParam pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetQueryiv(target, pname, @params);
        }

        public static void GetQueryObjectiv(UInt32 id, klukule.OpenGL.GetQueryObjectParam pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetQueryObjectiv(id, pname, @params);
        }

        public static void GetQueryObjectuiv(UInt32 id, klukule.OpenGL.GetQueryObjectParam pname, [OutAttribute] UInt32[] @params)
        {
            Delegates.glGetQueryObjectuiv(id, pname, @params);
        }

        public static void GetQueryObjecti64v(UInt32 id, klukule.OpenGL.GetQueryObjectParam pname, [OutAttribute] Int64[] @params)
        {
            Delegates.glGetQueryObjecti64v(id, pname, @params);
        }

        public static void GetQueryObjectui64v(UInt32 id, klukule.OpenGL.GetQueryObjectParam pname, [OutAttribute] UInt64[] @params)
        {
            Delegates.glGetQueryObjectui64v(id, pname, @params);
        }

        public static void GetRenderbufferParameteriv(klukule.OpenGL.RenderbufferTarget target, klukule.OpenGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetRenderbufferParameteriv(target, pname, @params);
        }

        public static void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, klukule.OpenGL.RenderbufferParameterName pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetSamplerParameterIiv(UInt32 sampler, klukule.OpenGL.TextureParameterName pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetSamplerParameterIiv(sampler, pname, @params);
        }

        public static void GetSamplerParameterIuiv(UInt32 sampler, klukule.OpenGL.TextureParameterName pname, [OutAttribute] UInt32[] @params)
        {
            Delegates.glGetSamplerParameterIuiv(sampler, pname, @params);
        }

        public static void GetShaderiv(UInt32 shader, klukule.OpenGL.ShaderParameter pname, [OutAttribute] Int32[] @params)
        {
        ...
        public static void GetShaderPrecisionFormat(klukule.OpenGL.ShaderType shaderType, Int32 precisionType, [OutAttribute] Int32[] range, [OutAttribute] Int32[] precision)
        {
        ...
        public static IntPtr GetString(klukule.OpenGL.StringName name)
        {
            return Delegates.glGetString(name);
        }

        public static IntPtr GetStringi(klukule.OpenGL.StringName name, UInt32 index)
        {
            return Delegates.glGetStringi(name, index);
        }

        public static UInt32 GetSubroutineIndex(UInt32 program, klukule.OpenGL.ShaderType shadertype, String name)
        {
            return Delegates.glGetSubroutineIndex(program, shadertype, name);
        }

        public static Int32 GetSubroutineUniformLocation(UInt32 program, klukule.OpenGL.ShaderType shadertype, String name)
        {
            return Delegates.glGetSubroutineUniformLocation(program, shadertype, name);
        }

        public static void GetSynciv(IntPtr sync, klukule.OpenGL.ArbSync pname, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] values)
        {
            Delegates.glGetSynciv(sync, pname, bufSize, length, values);
        }

        public static void GetTexImage(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetTexImage(target, level, format, type, pixels);
        }

        public static void GetnTexImage(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetnTexImage(target, level, format, type, bufSize, pixels);
        }

        public static void GetTextureImage(UInt32 texture, Int32 level, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetTextureImage(texture, level, format, type, bufSize, pixels);
        }

        public static void GetTexLevelParameterfv(klukule.OpenGL.GetPName target, Int32 level, klukule.OpenGL.GetTextureLevelParameter pname, [OutAttribute] Single[] @params)
        {
            Delegates.glGetTexLevelParameterfv(target, level, pname, @params);
        }

        public static void GetTexLevelParameteriv(klukule.OpenGL.GetPName target, Int32 level, klukule.OpenGL.GetTextureLevelParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTexLevelParameteriv(target, level, pname, @params);
        }

        public static void GetTextureLevelParameterfv(UInt32 texture, Int32 level, klukule.OpenGL.GetTextureLevelParameter pname, [OutAttribute] Single[] @params)
        {
            Delegates.glGetTextureLevelParameterfv(texture, level, pname, @params);
        }

        public static void GetTextureLevelParameteriv(UInt32 texture, Int32 level, klukule.OpenGL.GetTextureLevelParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTextureLevelParameteriv(texture, level, pname, @params);
        }

        public static void GetTexParameterfv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Single[] @params)
        {
            Delegates.glGetTexParameterfv(target, pname, @params);
        }

        public static void GetTexParameteriv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTexParameteriv(target, pname, @params);
        }

        public static void GetTexParameterIiv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTexParameterIiv(target, pname, @params);
        }

        public static void GetTexParameterIuiv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] UInt32[] @params)
        {
            Delegates.glGetTexParameterIuiv(target, pname, @params);
        }

        public static void GetTextureParameterfv(UInt32 texture, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Single[] @params)
        {
            Delegates.glGetTextureParameterfv(texture, pname, @params);
        }

        public static void GetTextureParameteriv(UInt32 texture, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTextureParameteriv(texture, pname, @params);
        }

        public static void GetTextureParameterIiv(UInt32 texture, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetTextureParameterIiv(texture, pname, @params);
        }

        public static void GetTextureParameterIuiv(UInt32 texture, klukule.OpenGL.GetTextureParameter pname, [OutAttribute] UInt32[] @params)
        {
            Delegates.glGetTextureParameterIuiv(texture, pname, @params);
        }

        public static void GetTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bufSize, pixels);
        }

        public static void GetTransformFeedbackiv(UInt32 xfb, klukule.OpenGL.TransformFeedbackParameterName pname, [OutAttribute] Int32[] param)
        {
            Delegates.glGetTransformFeedbackiv(xfb, pname, param);
        }

        public static void GetTransformFeedbacki_v(UInt32 xfb, klukule.OpenGL.TransformFeedbackParameterName pname, UInt32 index, [OutAttribute] Int32[] param)
        {
            Delegates.glGetTransformFeedbacki_v(xfb, pname, index, param);
        }

        public static void GetTransformFeedbacki64_v(UInt32 xfb, klukule.OpenGL.TransformFeedbackParameterName pname, UInt32 index, [OutAttribute] Int64[] param)
        {
            Delegates.glGetTransformFeedbacki64_v(xfb, pname, index, param);
        }

        public static void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] klukule.OpenGL.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name)
        {
        ...
        public static void GetUniformSubroutineuiv(klukule.OpenGL.ShaderType shadertype, Int32 location, [OutAttribute] UInt32[] values)
        {
            Delegates.glGetUniformSubroutineuiv(shadertype, location, values);
        }

        public static void GetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Int64[] param)
        {
            Delegates.glGetVertexArrayIndexed64iv(vaobj, index, pname, param);
        }

        public static void GetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Int32[] param)
        {
            Delegates.glGetVertexArrayIndexediv(vaobj, index, pname, param);
        }

        public static void GetVertexArrayiv(UInt32 vaobj, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Int32[] param)
        {
            Delegates.glGetVertexArrayiv(vaobj, pname, param);
        }

        public static void GetVertexAttribdv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Double[] @params)
        {
            Delegates.glGetVertexAttribdv(index, pname, @params);
        }

        public static void GetVertexAttribfv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Single[] @params)
        {
            Delegates.glGetVertexAttribfv(index, pname, @params);
        }

        public static void GetVertexAttribiv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetVertexAttribiv(index, pname, @params);
        }

        public static void GetVertexAttribIiv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Int32[] @params)
        {
            Delegates.glGetVertexAttribIiv(index, pname, @params);
        }

        public static void GetVertexAttribIuiv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] UInt32[] @params)
        {
            Delegates.glGetVertexAttribIuiv(index, pname, @params);
        }

        public static void GetVertexAttribLdv(UInt32 index, klukule.OpenGL.VertexAttribParameter pname, [OutAttribute] Double[] @params)
        {
            Delegates.glGetVertexAttribLdv(index, pname, @params);
        }

        public static void GetVertexAttribPointerv(UInt32 index, klukule.OpenGL.VertexAttribPointerParameter pname, [OutAttribute] IntPtr pointer)
        {
            Delegates.glGetVertexAttribPointerv(index, pname, pointer);
        }

        public static void Hint(klukule.OpenGL.HintTarget target, klukule.OpenGL.HintMode mode)
        {
        ...
        public static void InvalidateFramebuffer(klukule.OpenGL.FramebufferTarget target, Int32 numAttachments, klukule.OpenGL.FramebufferAttachment[] attachments)
        {
            Delegates.glInvalidateFramebuffer(target, numAttachments, attachments);
        }

        public static void InvalidateNamedFramebufferData(UInt32 framebuffer, Int32 numAttachments, klukule.OpenGL.FramebufferAttachment[] attachments)
        {
            Delegates.glInvalidateNamedFramebufferData(framebuffer, numAttachments, attachments);
        }

        public static void InvalidateSubFramebuffer(klukule.OpenGL.FramebufferTarget target, Int32 numAttachments, klukule.OpenGL.FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height)
        {
            Delegates.glInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height);
        }

        public static void InvalidateNamedFramebufferSubData(UInt32 framebuffer, Int32 numAttachments, klukule.OpenGL.FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height)
        {
        ...
        public static Boolean IsEnabled(klukule.OpenGL.EnableCap cap)
        {
            return Delegates.glIsEnabled(cap);
        }

        public static Boolean IsEnabledi(klukule.OpenGL.EnableCap cap, UInt32 index)
        {
        ...
        public static void LogicOp(klukule.OpenGL.LogicOp opcode)
        {
            Delegates.glLogicOp(opcode);
        }

        public static IntPtr MapBuffer(klukule.OpenGL.BufferTarget target, klukule.OpenGL.BufferAccess access)
        {
            return Delegates.glMapBuffer(target, access);
        }

        public static IntPtr MapNamedBuffer(UInt32 buffer, klukule.OpenGL.BufferAccess access)
        {
            return Delegates.glMapNamedBuffer(buffer, access);
        }

        public static IntPtr MapBufferRange(klukule.OpenGL.BufferTarget target, IntPtr offset, IntPtr length, klukule.OpenGL.BufferAccessMask access)
        {
        ...
        public static void MultiDrawArrays(klukule.OpenGL.BeginMode mode, Int32[] first, Int32[] count, Int32 drawcount)
        {
            Delegates.glMultiDrawArrays(mode, first, count, drawcount);
        }

        public static void MultiDrawArraysIndirect(klukule.OpenGL.BeginMode mode, IntPtr indirect, Int32 drawcount, Int32 stride)
        {
            Delegates.glMultiDrawArraysIndirect(mode, indirect, drawcount, stride);
        }

        public static void MultiDrawElements(klukule.OpenGL.BeginMode mode, Int32[] count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 drawcount)
        {
            Delegates.glMultiDrawElements(mode, count, type, indices, drawcount);
        }

        public static void MultiDrawElementsBaseVertex(klukule.OpenGL.BeginMode mode, Int32[] count, klukule.OpenGL.DrawElementsType type, IntPtr indices, Int32 drawcount, Int32[] basevertex)
        {
            Delegates.glMultiDrawElementsBaseVertex(mode, count, type, indices, drawcount, basevertex);
        }

        public static void MultiDrawElementsIndirect(klukule.OpenGL.BeginMode mode, klukule.OpenGL.DrawElementsType type, IntPtr indirect, Int32 drawcount, Int32 stride)
        {
            Delegates.glMultiDrawElementsIndirect(mode, type, indirect, drawcount, stride);
        }

        public static void ObjectLabel(klukule.OpenGL.ObjectLabel identifier, UInt32 name, Int32 length, String label)
        {
        ...
        public static void PixelStoref(klukule.OpenGL.PixelStoreParameter pname, Single param)
        {
            Delegates.glPixelStoref(pname, param);
        }

        public static void PixelStorei(klukule.OpenGL.PixelStoreParameter pname, Int32 param)
        {
            Delegates.glPixelStorei(pname, param);
        }

        public static void PointParameterf(klukule.OpenGL.PointParameterName pname, Single param)
        {
            Delegates.glPointParameterf(pname, param);
        }

        public static void PointParameteri(klukule.OpenGL.PointParameterName pname, Int32 param)
        {
            Delegates.glPointParameteri(pname, param);
        }

        public static void PointParameterfv(klukule.OpenGL.PointParameterName pname, Single[] @params)
        {
            Delegates.glPointParameterfv(pname, @params);
        }

        public static void PointParameteriv(klukule.OpenGL.PointParameterName pname, Int32[] @params)
        {
        ...
        public static void PolygonMode(klukule.OpenGL.MaterialFace face, klukule.OpenGL.PolygonMode mode)
        {
        ...
        public static void ProgramParameteri(UInt32 program, klukule.OpenGL.Version32 pname, Int32 value)
        {
        ...
        public static void ProvokingVertex(klukule.OpenGL.ProvokingVertexMode provokeMode)
        {
        ...
        public static void ReadBuffer(klukule.OpenGL.ReadBufferMode mode)
        {
            Delegates.glReadBuffer(mode);
        }

        public static void NamedFramebufferReadBuffer(UInt32 framebuffer, klukule.OpenGL.BeginMode mode)
        {
            Delegates.glNamedFramebufferReadBuffer(framebuffer, mode);
        }

        public static void ReadPixels(Int32 x, Int32 y, Int32 width, Int32 height, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, Int32[] data)
        {
            Delegates.glReadPixels(x, y, width, height, format, type, data);
        }

        public static void ReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, Int32 bufSize, Int32[] data)
        {
            Delegates.glReadnPixels(x, y, width, height, format, type, bufSize, data);
        }

        public static void RenderbufferStorage(klukule.OpenGL.RenderbufferTarget target, klukule.OpenGL.RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
            Delegates.glRenderbufferStorage(target, internalFormat, width, height);
        }

        public static void NamedRenderbufferStorage(UInt32 renderbuffer, klukule.OpenGL.RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
            Delegates.glNamedRenderbufferStorage(renderbuffer, internalFormat, width, height);
        }

        public static void RenderbufferStorageMultisample(klukule.OpenGL.RenderbufferTarget target, Int32 samples, klukule.OpenGL.RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
            Delegates.glRenderbufferStorageMultisample(target, samples, internalFormat, width, height);
        }

        public static void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, klukule.OpenGL.RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
        ...
        public static void SamplerParameterIiv(UInt32 sampler, klukule.OpenGL.TextureParameterName pname, Int32[] @params)
        {
            Delegates.glSamplerParameterIiv(sampler, pname, @params);
        }

        public static void SamplerParameterIuiv(UInt32 sampler, klukule.OpenGL.TextureParameterName pname, UInt32[] @params)
        {
        ...
        public static void StencilFunc(klukule.OpenGL.StencilFunction func, Int32 @ref, UInt32 mask)
        {
            Delegates.glStencilFunc(func, @ref, mask);
        }

        public static void StencilFuncSeparate(klukule.OpenGL.StencilFace face, klukule.OpenGL.StencilFunction func, Int32 @ref, UInt32 mask)
        {
        ...
        public static void StencilMaskSeparate(klukule.OpenGL.StencilFace face, UInt32 mask)
        {
            Delegates.glStencilMaskSeparate(face, mask);
        }

        public static void StencilOp(klukule.OpenGL.StencilOp sfail, klukule.OpenGL.StencilOp dpfail, klukule.OpenGL.StencilOp dppass)
        {
            Delegates.glStencilOp(sfail, dpfail, dppass);
        }

        public static void StencilOpSeparate(klukule.OpenGL.StencilFace face, klukule.OpenGL.StencilOp sfail, klukule.OpenGL.StencilOp dpfail, klukule.OpenGL.StencilOp dppass)
        {
            Delegates.glStencilOpSeparate(face, sfail, dpfail, dppass);
        }

        public static void TexBuffer(klukule.OpenGL.TextureBufferTarget target, klukule.OpenGL.SizedInternalFormat internalFormat, UInt32 buffer)
        {
            Delegates.glTexBuffer(target, internalFormat, buffer);
        }

        public static void TextureBuffer(UInt32 texture, klukule.OpenGL.SizedInternalFormat internalFormat, UInt32 buffer)
        {
            Delegates.glTextureBuffer(texture, internalFormat, buffer);
        }

        public static void TexBufferRange(klukule.OpenGL.BufferTarget target, klukule.OpenGL.SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, IntPtr size)
        {
            Delegates.glTexBufferRange(target, internalFormat, buffer, offset, size);
        }

        public static void TextureBufferRange(UInt32 texture, klukule.OpenGL.SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, Int32 size)
        {
            Delegates.glTextureBufferRange(texture, internalFormat, buffer, offset, size);
        }

        public static void TexImage1D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 border, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glTexImage1D(target, level, internalFormat, width, border, format, type, data);
        }

        public static void TexImage2D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glTexImage2D(target, level, internalFormat, width, height, border, format, type, data);
        }

        public static void TexImage2DMultisample(klukule.OpenGL.TextureTargetMultisample target, Int32 samples, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations)
        {
            Delegates.glTexImage2DMultisample(target, samples, internalFormat, width, height, fixedsamplelocations);
        }

        public static void TexImage3D(klukule.OpenGL.TextureTarget target, Int32 level, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr data)
        {
            Delegates.glTexImage3D(target, level, internalFormat, width, height, depth, border, format, type, data);
        }

        public static void TexImage3DMultisample(klukule.OpenGL.TextureTargetMultisample target, Int32 samples, klukule.OpenGL.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations)
        {
            Delegates.glTexImage3DMultisample(target, samples, internalFormat, width, height, depth, fixedsamplelocations);
        }

        public static void TexParameterf(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, Single param)
        {
            Delegates.glTexParameterf(target, pname, param);
        }

        public static void TexParameteri(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, Int32 param)
        {
            Delegates.glTexParameteri(target, pname, param);
        }

        public static void TextureParameterf(UInt32 texture, klukule.OpenGL.TextureParameter pname, Single param)
        {
            Delegates.glTextureParameterf(texture, pname, param);
        }

        public static void TextureParameteri(UInt32 texture, klukule.OpenGL.TextureParameter pname, Int32 param)
        {
            Delegates.glTextureParameteri(texture, pname, param);
        }

        public static void TexParameterfv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, Single[] @params)
        {
            Delegates.glTexParameterfv(target, pname, @params);
        }

        public static void TexParameteriv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, Int32[] @params)
        {
            Delegates.glTexParameteriv(target, pname, @params);
        }

        public static void TexParameterIiv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, Int32[] @params)
        {
            Delegates.glTexParameterIiv(target, pname, @params);
        }

        public static void TexParameterIuiv(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, UInt32[] @params)
        {
            Delegates.glTexParameterIuiv(target, pname, @params);
        }

        public static void TextureParameterfv(UInt32 texture, klukule.OpenGL.TextureParameter pname, Single[] paramtexture)
        {
            Delegates.glTextureParameterfv(texture, pname, paramtexture);
        }

        public static void TextureParameteriv(UInt32 texture, klukule.OpenGL.TextureParameter pname, Int32[] param)
        {
            Delegates.glTextureParameteriv(texture, pname, param);
        }

        public static void TextureParameterIiv(UInt32 texture, klukule.OpenGL.TextureParameter pname, Int32[] @params)
        {
            Delegates.glTextureParameterIiv(texture, pname, @params);
        }

        public static void TextureParameterIuiv(UInt32 texture, klukule.OpenGL.TextureParameter pname, UInt32[] @params)
        {
            Delegates.glTextureParameterIuiv(texture, pname, @params);
        }

        public static void TexStorage1D(klukule.OpenGL.TextureTarget target, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width)
        {
            Delegates.glTexStorage1D(target, levels, internalFormat, width);
        }

        public static void TextureStorage1D(UInt32 texture, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width)
        {
            Delegates.glTextureStorage1D(texture, levels, internalFormat, width);
        }

        public static void TexStorage2D(klukule.OpenGL.TextureTarget target, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height)
        {
            Delegates.glTexStorage2D(target, levels, internalFormat, width, height);
        }

        public static void TextureStorage2D(UInt32 texture, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height)
        {
            Delegates.glTextureStorage2D(texture, levels, internalFormat, width, height);
        }

        public static void TexStorage2DMultisample(klukule.OpenGL.TextureTarget target, Int32 samples, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations)
        {
            Delegates.glTexStorage2DMultisample(target, samples, internalFormat, width, height, fixedsamplelocations);
        }

        public static void TextureStorage2DMultisample(UInt32 texture, Int32 samples, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations)
        {
            Delegates.glTextureStorage2DMultisample(texture, samples, internalFormat, width, height, fixedsamplelocations);
        }

        public static void TexStorage3D(klukule.OpenGL.TextureTarget target, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth)
        {
            Delegates.glTexStorage3D(target, levels, internalFormat, width, height, depth);
        }

        public static void TextureStorage3D(UInt32 texture, Int32 levels, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth)
        {
            Delegates.glTextureStorage3D(texture, levels, internalFormat, width, height, depth);
        }

        public static void TexStorage3DMultisample(klukule.OpenGL.TextureTarget target, Int32 samples, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations)
        {
            Delegates.glTexStorage3DMultisample(target, samples, internalFormat, width, height, depth, fixedsamplelocations);
        }

        public static void TextureStorage3DMultisample(UInt32 texture, Int32 samples, klukule.OpenGL.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations)
        {
            Delegates.glTextureStorage3DMultisample(texture, samples, internalFormat, width, height, depth, fixedsamplelocations);
        }

        public static void TexSubImage1D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
            Delegates.glTexSubImage1D(target, level, xoffset, width, format, type, pixels);
        }

        public static void TextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
            Delegates.glTextureSubImage1D(texture, level, xoffset, width, format, type, pixels);
        }

        public static void TexSubImage2D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
            Delegates.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels);
        }

        public static void TextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
            Delegates.glTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, type, pixels);
        }

        public static void TexSubImage3D(klukule.OpenGL.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
            Delegates.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
        }

        public static void TextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, klukule.OpenGL.PixelFormat format, klukule.OpenGL.PixelType type, IntPtr pixels)
        {
        ...
        public static void TextureView(UInt32 texture, klukule.OpenGL.TextureTarget target, UInt32 origtexture, klukule.OpenGL.PixelInternalFormat internalFormat, UInt32 minlevel, UInt32 numlevels, UInt32 minlayer, UInt32 numlayers)
        {
        ...
        public static void TransformFeedbackVaryings(UInt32 program, Int32 count, String[] varyings, klukule.OpenGL.TransformFeedbackMode bufferMode)
        {
        ...
        public static void UniformSubroutinesuiv(klukule.OpenGL.ShaderType shadertype, Int32 count, UInt32[] indices)
        {
            Delegates.glUniformSubroutinesuiv(shadertype, count, indices);
        }

        public static Boolean UnmapBuffer(klukule.OpenGL.BufferTarget target)
        {
        ...
        public static void VertexAttribP1ui(UInt32 index, klukule.OpenGL.VertexAttribPType type, Boolean normalized, UInt32 value)
        {
            Delegates.glVertexAttribP1ui(index, type, normalized, value);
        }

        public static void VertexAttribP2ui(UInt32 index, klukule.OpenGL.VertexAttribPType type, Boolean normalized, UInt32 value)
        {
            Delegates.glVertexAttribP2ui(index, type, normalized, value);
        }

        public static void VertexAttribP3ui(UInt32 index, klukule.OpenGL.VertexAttribPType type, Boolean normalized, UInt32 value)
        {
            Delegates.glVertexAttribP3ui(index, type, normalized, value);
        }

        public static void VertexAttribP4ui(UInt32 index, klukule.OpenGL.VertexAttribPType type, Boolean normalized, UInt32 value)
        {
        ...
        public static void VertexAttribFormat(UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset)
        {
            Delegates.glVertexAttribFormat(attribindex, size, type, normalized, relativeoffset);
        }

        public static void VertexAttribIFormat(UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, UInt32 relativeoffset)
        {
            Delegates.glVertexAttribIFormat(attribindex, size, type, relativeoffset);
        }

        public static void VertexAttribLFormat(UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, UInt32 relativeoffset)
        {
            Delegates.glVertexAttribLFormat(attribindex, size, type, relativeoffset);
        }

        public static void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset)
        {
            Delegates.glVertexArrayAttribFormat(vaobj, attribindex, size, type, normalized, relativeoffset);
        }

        public static void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, UInt32 relativeoffset)
        {
            Delegates.glVertexArrayAttribIFormat(vaobj, attribindex, size, type, relativeoffset);
        }

        public static void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, klukule.OpenGL.VertexAttribFormat type, UInt32 relativeoffset)
        {
            Delegates.glVertexArrayAttribLFormat(vaobj, attribindex, size, type, relativeoffset);
        }

        public static void VertexAttribPointer(UInt32 index, Int32 size, klukule.OpenGL.VertexAttribPointerType type, Boolean normalized, Int32 stride, IntPtr pointer)
        {
            Delegates.glVertexAttribPointer(index, size, type, normalized, stride, pointer);
        }

        public static void VertexAttribIPointer(UInt32 index, Int32 size, klukule.OpenGL.VertexAttribPointerType type, Int32 stride, IntPtr pointer)
        {
            Delegates.glVertexAttribIPointer(index, size, type, stride, pointer);
        }

        public static void VertexAttribLPointer(UInt32 index, Int32 size, klukule.OpenGL.VertexAttribPointerType type, Int32 stride, IntPtr pointer)
        {
