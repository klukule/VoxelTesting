...
namespace klukule.OpenGL
{
    partial class Gl
    {
        ...
        public static void TexParameteri(klukule.OpenGL.TextureTarget target, klukule.OpenGL.TextureParameterName pname, TextureParameter param)
        {
        ...
        /// <summary>
        /// Gets the current klukule.OpenGL version (returns a cached result on subsequent calls).
        /// </summary>
        /// <returns>The current klukule.OpenGL version, or 0 on an error.</returns>
        public static int Version()
        {
            ...
            {
                Console.WriteLine("Error while retrieving the klukule.OpenGL version.");
                return 0;
            }
        }
        ...
        /// <summary>
        /// Delete a single klukule.OpenGL buffer.
        /// </summary>
        /// <param name="buffer">The klukule.OpenGL buffer to delete.</param>
